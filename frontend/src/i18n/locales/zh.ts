export default {
  ...
  nav: {
    ...
    subscriptionLedger: '订阅账本',
    subscriptionRefundRequests: '退款申请',
    buySubscription: '充值/订阅',
    docs: '文档',
    supportContacts: '群聊/客服',
    qqGroup: 'QQ群',
    customerService: '客服号码',
    userGuide: '使用文档',
    myOrders: '我的订单',
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    timedGroupAccessRemaining: '限时 {time}',
    timedGroupAccessExpiresAt: '限时专属分组，有效至 {time}',
    timedGroupAccessExpired: '即将失效',
    timeRemainingMinutes: '{minutes}分钟',
    timeRemainingHours: '{hours}小时',
    timeRemainingDays: '{days}天',
    timeRemainingDaysHours: '{days}天{hours}小时',
    paidFailover: {
      title: '允许付费备用分组',
  ...
  affiliate: {
    ...
    tips: {
      title: '使用说明',
      share: '分享邀请码或邀请链接，新用户注册后会与你绑定邀请关系。',
      paymentReward: '被邀请用户完成余额充值或订阅购买后，你可获得邀请奖励。',
      rebate: '返利按实际支付金额计算：支付金额 × {rate}；{freezeRule}。',
      limits: '返利关系有效期为 {duration}，单个被邀请用户返利上限为 {cap}。',
      groupGrant: '若平台开启限时专属分组奖励，被邀请用户支付后，你还可获得限时专属分组使用权限。',
      groupGrantDays: '专属分组有效期按支付金额计算：10 元以内含 10 元为 1 天，之后每满 10 元增加 1 天。',
      groupGrantStack: '多次支付可叠加有效期；到期后自动失效，创建 Key 或切换分组时可查看剩余时间。',
      once: '同一订单只发放一次奖励，具体规则以平台当前配置为准。',
      noFreeze: '无冻结期',
      noFreezeRule: '无冻结期，返利产生后可转入账户余额',
      freezeRule: '冻结期为 {freeze}，到期后可转入账户余额',
      permanent: '永久有效',
      unlimited: '不限制',
      hours: '{count} 小时',
      days: '{count} 天',
  ...
  admin: {
    ...
    dashboard: {
      ...
      totalUsers: '用户总数',
      activeUsers: '活跃用户',
      remainingCredit: '用户剩余额度',
      remainingSubscription: '订阅',
      remainingBalance: '余额',
      accounts: '账号',
      totalAccounts: '账号总数',
      activeAccounts: '活跃账号',
    ...
    groups: {
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      subscriptionRateMultiplierHint: '订阅额度优先消耗时使用该倍率；余额补扣仍使用费率倍数',
      rateMultiplierSplitSummary: '余额 {balance} / 订阅 {subscription}',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
        openai: 'OpenAI',
      ...
      accountPriority: {
        action: '账号排序',
        title: '{name} 账号排序',
        hint: '拖拽账号调整该分组内调度顺序，排在前面的账号会优先参与调度。',
        empty: '该分组暂无绑定账号',
        accountPriority: '账号优先级 {value}',
        unschedulable: '不可调度',
        moveUp: '上移',
        moveDown: '下移',
        updated: '账号排序已更新',
        failedToLoad: '加载账号排序失败',
        failedToUpdate: '更新账号排序失败'
      },
    ...
    subscriptions: {
      ...
      batchAdjustSubscription: '批量调整',
      batchResetQuota: '批量重置配额',
      ...
      selectUser: '选择用户',
      selectGroup: '选择订阅套餐',
      planHint: '选择要分配给用户的订阅套餐',
      groupHint: '仅显示订阅计费类型的分组',
      validityHint: '订阅的有效天数',
      adjustingFor: '为以下用户调整订阅',
      adjustingSelectedCount: '为已选的 {count} 个订阅调整有效期',
      resettingSelectedCount: '为已选的 {count} 个订阅重置用量窗口',
      selectedSubscriptions: '已选订阅',
      moreSelectedSubscriptions: '等另外 {count} 个订阅',
      ...
      refund: '退款',
      refundSuccess: '退款已完成',
      refundPending: '网关退款已完成，人工转账部分等待凭证处理',
      refundFailed: '退款处理失败',
      resetQuota: '重置配额',
      resetQuotaTitle: '重置用量配额',
      resetQuotaOptions: '重置范围',
      resetQuotaHint: '至少选择一个窗口。重置后用量会归零，并从今天开始重新计算。',
      resetQuotaDescription: "选择要重置的窗口。'{user}' 的用量会归零，并从今天开始重新计算。",
      resetDailyQuota: '重置每日用量',
      resetWeeklyQuota: '重置每周用量',
      resetMonthlyQuota: '重置每月用量',
      resetQuotaConfirm: "确定要重置 '{user}' 的每日、每周和每月用量配额吗？用量将归零并从今天开始重新计算。",
      quotaResetSuccess: '配额重置成功',
      batchResetQuotaSummary: '批量重置完成：成功 {success} 个，失败 {failed} 个',
      failedToResetQuota: '重置配额失败',
      failedToBatchResetQuota: '批量重置配额失败',
      noSubscriptionsYet: '暂无订阅',
      assignFirstSubscription: '分配一个订阅以开始使用。',
      subscriptionAssigned: '订阅分配成功',
      subscriptionAdjusted: '订阅调整成功',
      batchAdjustSummary: '批量调整完成：成功 {success} 个，失败 {failed} 个',
      subscriptionRevoked: '订阅撤销成功',
      failedToLoad: '加载订阅列表失败',
      failedToAssign: '分配订阅失败',
      failedToAdjust: '调整订阅失败',
      failedToBatchAdjust: '批量调整订阅失败',
      failedToRevoke: '撤销订阅失败',
      adjustWouldExpire: '调整后剩余天数必须大于0',
      adjustOutOfRange: '调整天数必须在 -36500 到 36500 之间',
      pleaseSelectSubscriptions: '请先选择要调整的订阅',
      pleaseSelectSubscriptionsToReset: '请先选择要重置的订阅',
      pleaseSelectResetQuotaWindow: '请至少选择一个要重置的窗口',
      ...
      guide: {
        ...
        actions: {
          batchAdjust: '批量调整',
          batchAdjustDesc: '一次为多个订阅统一延长或缩短有效期',
          adjust: '调整',
    ...
    subscriptionRefundRequests: {
      title: '退款申请管理',
      description: '处理订阅残值退款、网关退款与人工补差'
    },
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          groupGrantEnabled: '充值赠送限时专属分组',
          groupGrantEnabledHint: '被邀请用户完成余额充值或订阅购买后，邀请人获得限时专属分组权限。',
          groupGrantGroupId: '赠送目标分组 ID',
          groupGrantGroupIdDesc: '必须填写已启用的专属分组 ID。权限按实际支付金额计算自然日，到期后不保留到永久分组。',
          customUsers: {
            title: '专属用户配置',
      ...
      site: {
        ...
        qqGroupNumberHint: '填写后将在顶部导航的群聊/客服入口中展示',
        contactInfo: '客服号码',
        contactInfoPlaceholder: '例如：987654321',
        contactInfoHint: '填写后将展示在顶部导航、兑换页面和个人资料等位置',
        docUrl: '文档链接',
      ...
      payment: {
        ...
        allowCustomRechargeAmount: '允许自定义充值金额',
        allowCustomRechargeAmountHint: '关闭后，用户只能选择页面提供的快捷金额充值',
      ...
      insufficientBalanceError: {
        enabled: '自定义余额不足错误',
        description: '仅替换余额不足时返回给客户端的错误码和文案，不改变协议格式。',
        code: '错误码 / 类型',
        codePlaceholder: '留空沿用默认',
        codeHint: '仅支持字母、数字、短横线和下划线。',
        message: '错误文案',
        messagePlaceholder: '账户余额不足，请充值后继续使用',
        messageHint: '留空沿用默认文案。',
      },
      saveSettings: '保存设置',
      saving: '保存中...',
  ...
  userSubscriptions: {
    ...
    refund: {
      ...
      previewHint: '预览结果 2 分钟内有效。',
      previewFailed: '计算退款预览失败',
      submitFailed: '提交退款申请失败',
      submitted: '退款申请已提交',
      submittedWithId: '退款申请已提交，编号 #{id}',
      previewExpired: '预览已过期，请重新计算。',
      residual: '可退残值',
      refundAmount: '实际退款',
      fee: '退款手续费',
      currentPlan: '当前套餐',
      ...
      settlementId: '当前结算单',
      afterSettlementValue: '结算后权益价值',
      residualKnives: '当前剩余刀数',
      unitCost: '单位刀成本',
      refundMode: '退款方式',
      gatewayRefundable: '网关可退',
      manualTransfer: '人工补差',
      expiresAt: '过期时间',
      previewCountdown: '预览倒计时',
      allocations: '分配明细',
      channelAvailable: '可走网关',
      channelUnavailable: '不可走网关',
      orderAmount: '订单金额',
      payAmount: '实付金额',
      alreadyRefundedAmount: '已退金额',
      refundableOrderAmount: '订单可退上限',
      allocatedRefundValue: '本次分配',
      gatewayRefundAmount: '网关实退',
      unavailableReason: '不可退原因',
      calculationTitle: '退款计算说明',
      calculationIntro: '退款金额会先按当前订阅残值计算，再按支付网关可退精度拆分为网关退款和人工补差。',
      calculationResidualFormula: '残值 = 剩余刀数 × 单位刀成本',
      calculationFeeFormula: '手续费 = 残值 × 5%，最高 10 元',
      calculationNetFormula: '实际退款 = 残值 - 手续费',
      calculationUnitCostHint: '其中单位刀成本 = 当前结算权益价值 {settlement} ÷ 理论总刀数 {knives} = {unitCost}',
      calculationGatewayFormula: '网关退款 = 当前支付订单可通过网关退回的金额合计',
      calculationManualFormula: '人工补差 = 残值 - 网关可退',
      calculationManualRequiredHint: '当前人工补差达到收款阈值，提交申请前需要填写收款信息。',
      calculationManualWaivedHint: '当前人工补差仅为小额尾差，不需要额外填写收款信息。',
      manualTransferRequired: '存在人工补差，需要填写收款信息',
      receiverType: '收款方式',
      receiverName: '收款人姓名',
      receiverAccount: '收款账号',
      receiverQrImageUrl: '收款二维码 URL',
      receiverQrImageHint: '请输入可访问的收款二维码图片地址',
      receiverRemark: '收款备注',
      receiverRemarkPlaceholder: '例如开户行、实名要求、转账附言等'
    }
  },

  subscriptionLedger: {
    title: '订阅账本',
    description: '查看订阅结算链路和权益变化',
    failedToLoad: '加载订阅账本失败',
    emptyTitle: '暂无订阅账本',
    emptyDesc: '当前没有订阅结算记录。',
    planUnknown: '未知套餐',
    subscriptionUnknown: '无订阅快照',
    subscriptionNo: '订阅',
    chainStart: '起点 #{id}',
    summary: {
      totalOrders: '结算单数',
  ...
  subscriptionRefundRequests: {
    title: '退款申请',
    description: '查看订阅残值退款进度与处理明细',
    emptyTitle: '暂无退款申请',
    emptyDescription: '您还没有提交任何订阅退款申请。',
    emptyAdminDescription: '当前没有需要处理的退款申请。',
    emptyAllocations: '暂无退款分配明细。',
    summary: {
      totalRequests: '申请总数',
      residual: '可退残值',
      gatewayRefundable: '网关可退',
       gatewayRefunded: '网关已退',
       refundFee: '退款手续费',
       refundAmount: '实际退款',
       manualTransfer: '人工补差'
    },
    sections: {
      ...
      allocations: '退款分配',
      subscription: '订阅信息',
      manualTransfer: '人工补差信息'
    },
    fields: {
      refundRequestNo: '退款申请',
      subscriptionNo: '订阅',
      currentSubscriptionStatus: '当前订阅状态',
      originalSubscriptionStatus: '原订阅状态',
      reason: '退款原因',
      adminNote: '管理员备注',
      previewIssuedAt: '预览生成时间',
      previewExpiresAt: '预览失效时间',
      submittedAt: '提交时间',
      frozenAt: '冻结时间',
      completedAt: '完成时间',
      cancelledAt: '取消时间',
      currentSettlementHead: '当前结算链头',
      expectedSettlementHead: '预期结算链头',
      receiverType: '收款方式',
      receiverName: '收款人',
      receiverAccount: '收款账号',
      receiverQrImageUrl: '收款二维码',
      receiverRemark: '收款备注',
      manualTransferProofUrl: '转账凭证',
      proofUploadedAt: '凭证上传时间'
    },
    table: {
      id: '申请ID',
      user: '用户',
      ...
      residual: '残值金额',
      gatewayRefund: '网关退款',
       residualSummary: '金额摘要',
       refundFee: '退款手续费',
       refundAmount: '实际退款',
       manualTransfer: '人工补差',
      previewExpiresAt: '预览失效',
      createdAt: '创建时间',
      actions: '操作'
    },
    allocationTable: {
      ...
      status: '状态',
      orderPayAmount: '实付金额',
      alreadyRefundedAmount: '已退款',
      refundableAmount: '订单可退',
      allocatedAmount: '本次分配',
    ...
    actions: {
      ...
      backList: '返回列表',
      refresh: '刷新',
      goSubscriptions: '返回订阅',
      processGateway: '执行网关退款',
      uploadProof: '填写转账凭证',
      saveProof: '保存转账凭证',
      complete: '完成退款',
      cancel: '取消申请',
    ...
    status: {
      submitted: '已提交',
      gateway_processing: '网关处理中',
      manual_pending: '人工补差待处理',
      completed: '已完成',
      failed: '处理失败',
      cancelled: '已取消'
    },
    ...
    placeholders: {
      proofUrl: '请输入转账凭证图片 URL',
      adminNote: '请输入备注（可选）'
    },
    hints: {
      completeRequiresProof: '该申请存在人工补差，完成前必须先填写转账凭证地址。',
      completeWaitGateway: '仍有网关退款未完成，暂不能结束退款。',
      cancelConfirm: '取消后订阅会按原状态恢复；只有在未发生实际退款时才能取消。',
      proofUpload: '请输入可访问的转账凭证图片地址。'
    },
    messages: {
      loadFailed: '加载退款申请失败',
      processGatewaySuccess: '已执行网关退款处理',
      processGatewayFailed: '执行网关退款失败',
      uploadProofSuccess: '已保存转账凭证',
      uploadProofFailed: '保存转账凭证失败',
      completeSuccess: '退款申请已完成',
      completeFailed: '完成退款申请失败',
      cancelSuccess: '退款申请已取消',
      cancelFailed: '取消退款申请失败'
    }
  },
  ...
  payment: {
    ...
    rechargeBonus: '赠送金额',
    calculatingQuote: '正在计算优惠',
    promotionApplied: '已应用优惠：{name}',
    quoteUnavailable: '暂时无法获取充值报价，请稍后重试',
    quoteChanged: '充值优惠或实付金额已变化，请确认最新报价后重试',
    refundReason: '退款原因',
    refundReasonPlaceholder: '请描述您的退款原因',
    refundPreview: '退款预览',
    refundPreviewLoading: '正在计算可退残值...',
    refundPreviewFailed: '退款预览失败',
    subscriptionRefundRedirect: '订阅订单退款已切换到订阅退款流程，请在订阅页面发起申请。',
    effectiveRefundAmount: '实际退款金额',
    gatewayRefundAmount: '支付通道退款',
       refundResidualValue: '残值退款',
       refundFeeAmount: '退款手续费',
    calculationTitle: '退款计算说明',
    calculationIntro: '退款预览会展示当前残值、支付通道可退金额，以及两者之间是否存在人工补差。',
       calculationResidualFormula: '残值退款',
       calculationFeeFormula: '手续费 = 残值 × 5%，最高 10 元',
       calculationNetFormula: '实际退款 = 残值 - 手续费',
    calculationGatewayFormula: '网关退款',
    calculationManualFormula: '人工补差 = 残值退款 - 网关退款',
    calculationManualRequiredHint: '如果人工补差大于 0，说明支付通道无法全额覆盖残值，后续会进入人工补差流程。',
    calculationManualWaivedHint: '如果人工补差等于 0，说明本次退款可以完全由支付通道完成。',
    ...
    errors: {
      ...
      CUSTOM_RECHARGE_AMOUNT_DISABLED: '当前只能选择快捷金额充值',
      INVALID_AMOUNT: '金额无效',
      INVALID_INPUT: '参数有误',
      ...
      USER_REFUND_DISABLED: '该订单暂不支持用户自助退款',
      REFUND_DISABLED: '该订单的支付通道未开启退款',
      PROVIDER_LOOKUP_FAILED: '支付通道查询失败',
      REFUND_REQUIRES_ADMIN_REVIEW: '该订阅退款需要后台审核处理',
      SETTLEMENT_REFUND_ALREADY_PENDING: '当前订阅已有退款申请处理中，请先处理现有申请。',
      SETTLEMENT_REFUND_PREVIEW_EXPIRED: '本次退款预览已过期，请重新计算。',
      SETTLEMENT_REFUND_PREVIEW_STALE: '本次退款预览已失效，请重新计算。',
      SETTLEMENT_REFUND_PREVIEW_TOKEN_INVALID: '退款预览凭证无效，请重新计算。',
      SETTLEMENT_REFUND_MANUAL_RECEIVER_REQUIRED: '存在人工补差，请先填写完整收款信息。',
      SETTLEMENT_REFUND_MANUAL_RECEIVER_IMAGE_INVALID: '收款二维码地址无效，请填写合法的图片地址或已存储路径。',
      SETTLEMENT_REFUND_COMPLETE_MANUAL_PROOF_REQUIRED: '存在人工补差，完成退款前必须先填写转账凭证地址。',
      SETTLEMENT_REFUND_MANUAL_PROOF_REQUIRED: '请先填写人工转账凭证地址。',
      SETTLEMENT_REFUND_MANUAL_PROOF_INVALID: '转账凭证地址无效，请填写合法的图片地址或已存储路径。',
      SETTLEMENT_REFUND_CANNOT_CANCEL_AFTER_PAYOUT: '该申请已经发生退款付款，不能取消。',
      REFUND_FAILED: '退款失败',
      RECHARGE_QUOTE_CHANGED: '充值报价已过期或优惠已变化，请刷新后重试',
      INVALID_RECHARGE_BONUS_RULE: '充值优惠规则填写有误',
      RECHARGE_BONUS_RULE_CONFLICT: '同优先级的启用规则存在金额和时间重叠',
      RECHARGE_BONUS_RULE_IN_USE: '该规则已被订单使用，只能停用，不能删除',
      RECHARGE_BONUS_RULE_NOT_FOUND: '充值优惠规则不存在',
    },
    ...
    targetPlan: '目标套餐',
    selectPlan: '选择套餐',
    residualValue: '剩余权益抵扣',
    upgradeDelta: '本次补差',
    upgradePreviewHint: '将按当前套餐剩余权益折抵后补差价。',
    upgradeCalculationTitle: '升级补差说明',
    upgradeCalculationIntro: '升级金额会先计算当前套餐剩余权益，再用目标套餐价格扣减该残值，整个过程按当前支付币种精度收口。',
    upgradeCalculationCurrentFormula: '单位权益成本',
    upgradeCalculationResidualFormula: '剩余权益抵扣',
    ...
    admin: {
      ...
      rechargeBonus: {
        ...
        edit: '编辑充值优惠',
        delete: '删除充值优惠',
        deleteConfirm: '确定删除这条充值优惠规则吗？',
        deleteInUse: '该规则可能已被订单使用，请改为停用',
        name: '规则名称',
        enabled: '启用',
        statusLabel: '状态',
        priority: '优先级',
        ...
        immediately: '立即开始',
        noEndTime: '长期有效',
        invalidAmountRange: '最高充值金额不能低于最低充值金额',
        invalidPercentage: '比例赠送不能超过 100%',
        invalidTimeRange: '结束时间必须晚于开始时间',
        status: { active: '进行中', upcoming: '未开始', ended: '已结束', disabled: '已停用' },
      },
      days: '天',
      weeks: '周',
      months: '月',
      ...
      refundPreview: '退款预览',
      refundPreviewLoading: '正在计算退款预览...',
      refundPreviewFailed: '退款预览失败',
      subscriptionRefundRedirect: '订阅订单退款已切换到结算单退款申请，请到退款申请列表处理。',
      affiliateRewardWarningTitle: '该订单已触发邀请奖励',
      affiliateRewardWarningBody: '退款不会自动追回邀请人的返利额度或限时专属分组权益，请管理员确认是否需要人工处理。',
      affiliateRebateApplied: '已发放返利额度：{amount}',
      affiliateInviterId: '邀请人用户 ID：{id}',
      affiliateGroupGrantApplied: '已赠送限时专属分组：{days} 天',
      affiliateGroupGrantExpiresAt: '限时分组当前到期时间：{time}',
      effectiveRefundAmount: '实际退款金额',
      currentResidualValue: '当前剩余残值',
      refundResidualValue: '残值退款',
      gatewayRefundAmount: '支付通道退款',
      calculationTitle: '退款计算说明',
      calculationIntro: '退款预览会展示当前残值、支付通道可退金额，以及两者之间是否存在人工补差。',
      ...
      calculationGatewayFormula: '网关退款',
      calculationManualFormula: '人工补差 = 残值退款 - 网关退款',
      calculationManualRequiredHint: '如果人工补差大于 0，说明支付通道无法全额覆盖残值，后续需要人工补差处理。',
      calculationManualWaivedHint: '如果人工补差等于 0，说明本次退款可以完全由支付通道完成。',
      refundReason: '退款原因',
      ...
      deductSubscription: '回收订阅权益',
      deductSubscriptionHint: '按当前订阅残值计算实际退款',
      userBalance: '用户余额',
      orderAmount: '订单金额',
      ...
      planScope: '套餐范围',
      userLevelPlan: '用户级套餐',
      legacyGroupBinding: '历史分组绑定',
      legacyGroupBindingHint: '该套餐来自旧分组订阅模型。当前编辑将按用户级套餐保存，并清除旧的分组绑定。',
      groupId: '分组 ID',
      features: '功能特性',
      featuresHint: '每行一个特性',
      ...
      validityValueRequired: '有效期数值必须大于 0',
      groupMissing: '缺失',
      groupInfo: '分组信息',
      platform: '平台',

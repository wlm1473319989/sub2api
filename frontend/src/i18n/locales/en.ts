export default {
  ...
  nav: {
    ...
    paymentPlans: 'Plans',
    rechargePromotions: 'Recharge Promotions',
  ...
  keys: {
    ...
    timedGroupAccessRemaining: 'Timed {time}',
    timedGroupAccessExpiresAt: 'Temporary exclusive group access, valid until {time}',
    timedGroupAccessExpired: 'Expiring now',
    timeRemainingMinutes: '{minutes}m',
    timeRemainingHours: '{hours}h',
    timeRemainingDays: '{days}d',
    timeRemainingDaysHours: '{days}d {hours}h',
    paidFailover: {
  ...
  affiliate: {
    ...
    tips: {
      title: 'How It Works',
      share: 'Share your affiliate code or invite link. New users bind to you after signup.',
      paymentReward: 'When invitees complete a balance recharge or subscription purchase, you can receive invite rewards.',
      rebate: 'Rebate is calculated from actual paid amount: paid amount x {rate}. {freezeRule}.',
      limits: 'The rebate relationship is valid for {duration}. The per-invitee rebate cap is {cap}.',
      groupGrant: 'If timed exclusive group rewards are enabled, invitee payments also grant you temporary exclusive group access.',
      groupGrantDays: 'Group access duration is based on paid amount: up to and including 10 = 1 day, then each full 10 adds 1 day.',
      groupGrantStack: 'Multiple payments can extend the expiry. It expires automatically, and remaining time is shown when creating or switching keys.',
      once: 'Each order grants rewards once only. Final rules follow the current platform configuration.',
      noFreeze: 'no freeze period',
      noFreezeRule: 'No freeze period; rebate can be transferred to balance after it is created',
      freezeRule: 'Freeze period is {freeze}; after that, rebate can be transferred to balance',
      permanent: 'permanent',
      unlimited: 'unlimited',
      hours: '{count} hours',
      days: '{count} days',
  ...
  admin: {
    ...
    dashboard: {
      ...
      accounts: 'Accounts',
      users: 'Users',
      remainingCredit: 'User Remaining',
      remainingSubscription: 'Subscription',
    ...
    groups: {
      ...
      accountPriority: {
        ...
        title: '{name} Account Order',
        hint: 'Drag accounts to adjust scheduling order inside this group. Accounts near the top are scheduled first.',
        empty: 'No accounts are bound to this group',
        accountPriority: 'Account priority {value}',
        unschedulable: 'Unschedulable',
        moveUp: 'Move up',
        moveDown: 'Move down',
        updated: 'Account order updated',
        failedToLoad: 'Failed to load account order',
        failedToUpdate: 'Failed to update account order'
      },
    ...
    subscriptions: {
      ...
      batchAdjustSubscription: 'Batch Adjust',
      batchResetQuota: 'Batch Reset Quota',
      ...
      adjustingSelectedCount: 'Adjust validity for {count} selected subscriptions',
      resettingSelectedCount: 'Reset usage windows for {count} selected subscriptions',
      selectedSubscriptions: 'Selected subscriptions',
      moreSelectedSubscriptions: '{count} more selected subscriptions',
      currentExpiration: 'Current expiration',
      ...
      refundPending: 'Gateway refund completed; manual transfer is awaiting proof',
      refundFailed: 'Refund processing failed',
      resetQuota: 'Reset Quota',
      resetQuotaTitle: 'Reset Usage Quota',
      resetQuotaOptions: 'Reset Windows',
      resetQuotaHint: 'Select at least one window. Usage will be zeroed and recalculated from today.',
      resetQuotaDescription: "Choose which windows to reset. Usage for '{user}' will be zeroed and recalculated from today.",
      resetDailyQuota: 'Reset daily usage',
      resetWeeklyQuota: 'Reset weekly usage',
      resetMonthlyQuota: 'Reset monthly usage',
      ...
      quotaResetSuccess: 'Quota reset successfully',
      batchResetQuotaSummary: 'Batch reset completed: {success} succeeded, {failed} failed',
      failedToResetQuota: 'Failed to reset quota',
      failedToBatchResetQuota: 'Failed to batch reset quota',
      ...
      batchAdjustSummary: 'Batch adjustment completed: {success} succeeded, {failed} failed',
      ...
      failedToBatchAdjust: 'Failed to batch adjust subscriptions',
      ...
      pleaseSelectSubscriptions: 'Please select subscriptions to adjust',
      pleaseSelectSubscriptionsToReset: 'Please select subscriptions to reset',
      pleaseSelectResetQuotaWindow: 'Please select at least one window to reset',
      ...
      guide: {
        ...
        actions: {
          ...
          batchAdjustDesc: 'Extend or shorten multiple subscriptions with one action',
          adjust: 'Adjust',
    ...
    subscriptionRefundRequests: {
      ...
      description: 'Handle residual-value refund requests, gateway refunds, and manual make-up transfers'
    },
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          groupGrantEnabled: 'Grant Temporary Exclusive Group',
          groupGrantEnabledHint: 'When an invitee completes a balance recharge or subscription purchase, the inviter receives temporary exclusive group access.',
          groupGrantGroupId: 'Grant Target Group ID',
          groupGrantGroupIdDesc: 'Must be an active exclusive group ID. Access is calculated from actual paid amount as natural days and is not written to permanent groups.',
          customUsers: {
      ...
      site: {
        ...
        qqGroupNumberHint: 'Shown in the group and support menu in the top navigation',
        contactInfo: 'Support Number',
        contactInfoPlaceholder: 'e.g., 987654321',
        contactInfoHint: 'Shown in the top navigation, redeem page, profile, and other locations',
      ...
      payment: {
        ...
        allowCustomRechargeAmount: 'Allow Custom Recharge Amount',
        allowCustomRechargeAmountHint: 'When disabled, users can only recharge using the listed quick amounts.',
      ...
      insufficientBalanceError: {
        enabled: 'Customize insufficient balance error',
        description: 'Only replaces the client-facing code and message for insufficient balance. Protocol wrappers stay unchanged.',
        code: 'Error code / type',
        codePlaceholder: 'Leave empty to keep default',
        codeHint: 'Letters, numbers, hyphens, and underscores only.',
        message: 'Error message',
        messagePlaceholder: 'Insufficient balance. Please recharge and try again.',
        messageHint: 'Leave empty to keep the default message.',
      },
  ...
  userSubscriptions: {
    ...
    status: {
      active: 'Active',
      suspended: 'Suspended',
      suspended_refund: 'Refund Processing (Frozen)',
      expired: 'Expired',
      revoked: 'Revoked',
      superseded: 'Superseded',
      refunded: 'Refunded'
    ...
    refund: {
      ...
      previewHint: 'The preview is valid for 2 minutes.',
      previewFailed: 'Failed to calculate refund preview',
      submitFailed: 'Failed to submit refund request',
      submitted: 'Refund request submitted',
      submittedWithId: 'Refund request submitted, ID #{id}',
      previewExpired: 'The preview has expired. Please recalculate.',
      residual: 'Refundable residual',
      refundAmount: 'Effective refund',
      fee: 'Refund fee',
      gatewayRefundable: 'Gateway refundable',
      manualTransfer: 'Manual transfer',
      expiresAt: 'Expires at',
      allocations: 'Allocation Details',
      channelAvailable: 'Gateway available',
      channelUnavailable: 'Gateway unavailable',
      calculationTitle: 'Refund Calculation',
      calculationIntro: 'The refund is first calculated from the current subscription residual, then split into gateway refund and manual difference based on gateway precision.',
      calculationResidualFormula: 'Residual = Remaining quota knives x Unit cost',
      calculationFeeFormula: 'Fee = residual x 5%, capped at 10',
      calculationNetFormula: 'Effective refund = residual - fee',
      calculationUnitCostHint: 'Unit cost = settlement value {settlement} / theoretical total knives {knives} = {unitCost}',
      calculationGatewayFormula: 'Gateway refund = total amount still refundable through the payment gateway',
      calculationManualFormula: 'Manual difference = residual - gateway refundable',
      calculationManualRequiredHint: 'The manual difference exceeds the collection threshold, so receiver details are required before submission.',
      calculationManualWaivedHint: 'The manual difference is only a small rounding remainder, so no extra receiver details are required.',
      manualTransferRequired: 'Manual transfer is required. Please provide receiver details.',
      receiverType: 'Receiver Type',
      receiverName: 'Receiver Name',
      receiverAccount: 'Receiver Account',
      receiverQrImageUrl: 'QR Image URL',
      receiverQrImageHint: 'Enter a reachable receiver QR image URL.',
      receiverRemark: 'Receiver Remark',
      receiverRemarkPlaceholder: 'For example bank name, real-name note, or transfer memo'
    }
  },

  subscriptionLedger: {
    title: 'Subscription Ledger',
    description: 'View subscription settlement chain and entitlement changes',
    failedToLoad: 'Failed to load subscription ledger',
    emptyTitle: 'No subscription ledger',
    emptyDesc: 'There are no subscription settlement records yet.',
    planUnknown: 'Unknown plan',
      subscriptionUnknown: 'No subscription snapshot',
      subscriptionNo: 'Subscription',
      chainStart: 'Start #{id}',
      summary: {
        totalOrders: 'Settlement Orders',
        totalChains: 'Payment Chains',
    ...
    sources: {
      ...
      subscription_assign: 'Admin Assignment',
      admin_revoke: 'Admin Revoke'
    },
      status: {
        effective: 'Current Node',
        closed: 'Closed'
      },
      chain: {
        title: 'Payment Chain {index}',
        head: 'Chain Head',
  ...
  subscriptionRefundRequests: {
    ...
    description: 'Track settlement-based subscription refund requests and allocation details',
    emptyTitle: 'No refund requests',
    emptyDescription: 'You have not submitted any subscription refund requests yet.',
    emptyAdminDescription: 'There are no refund requests to process right now.',
    emptyAllocations: 'No allocation details yet.',
    summary: {
      totalRequests: 'Total Requests',
      residual: 'Refundable Residual',
      gatewayRefundable: 'Gateway Refundable',
      gatewayRefunded: 'Gateway Refunded',
    ...
    fields: {
      refundRequestNo: 'Refund Request',
      subscriptionNo: 'Subscription',
      currentSubscriptionStatus: 'Current Subscription Status',
      originalSubscriptionStatus: 'Original Subscription Status',
      reason: 'Refund Reason',
      adminNote: 'Admin Note',
      previewIssuedAt: 'Preview Issued At',
      previewExpiresAt: 'Preview Expires At',
      submittedAt: 'Submitted At',
      frozenAt: 'Frozen At',
      completedAt: 'Completed At',
      cancelledAt: 'Cancelled At',
      currentSettlementHead: 'Current Settlement Head',
      expectedSettlementHead: 'Expected Settlement Head',
      receiverType: 'Receiver Type',
      receiverName: 'Receiver Name',
      receiverAccount: 'Receiver Account',
      receiverQrImageUrl: 'Receiver QR Code',
      receiverRemark: 'Receiver Remark',
      manualTransferProofUrl: 'Transfer Proof',
      proofUploadedAt: 'Proof Uploaded At'
    },
    table: {
      id: 'Request ID',
      user: 'User',
      ...
      residualSummary: 'Amount Summary',
      refundFee: 'Refund Fee',
      refundAmount: 'Effective Refund',
      manualTransfer: 'Manual Transfer',
    ...
    allocationTable: {
      ...
      alreadyRefundedAmount: 'Already Refunded',
      refundableAmount: 'Order Refundable',
    ...
    actions: {
      ...
      processGateway: 'Process Gateway Refund',
      uploadProof: 'Enter Transfer Proof',
      saveProof: 'Save Transfer Proof',
    ...
    placeholders: {
      proofUrl: 'Enter the transfer proof image URL',
      adminNote: 'Enter an optional note'
    },
    hints: {
      completeRequiresProof: 'This request requires a manual transfer proof URL before it can be completed.',
      completeWaitGateway: 'Gateway refunds are still unfinished, so the request cannot be completed yet.',
      cancelConfirm: 'Cancelling restores the subscription to its original status. Cancellation is only allowed before any payout happens.',
      proofUpload: 'Enter a reachable transfer proof image URL.'
    },
    messages: {
      loadFailed: 'Failed to load refund requests',
      processGatewaySuccess: 'Gateway refund processing started',
      processGatewayFailed: 'Failed to process gateway refund',
      uploadProofSuccess: 'Transfer proof saved',
      uploadProofFailed: 'Failed to save transfer proof',
      completeSuccess: 'Refund request completed',
      completeFailed: 'Failed to complete refund request',
      cancelSuccess: 'Refund request cancelled',
      cancelFailed: 'Failed to cancel refund request'
    }
  },
  ...
  payment: {
    ...
    rechargeBonus: 'Bonus',
    calculatingQuote: 'Calculating promotion',
    promotionApplied: 'Promotion applied: {name}',
    quoteUnavailable: 'Unable to load the recharge quote. Please try again.',
    quoteChanged: 'The recharge promotion or payment amount changed. Review the latest quote and retry.',
    refundReason: 'Refund Reason',
    refundReasonPlaceholder: 'Please describe your refund reason',
    refundPreview: 'Refund Preview',
    refundPreviewLoading: 'Calculating refundable residual value...',
    refundPreviewFailed: 'Refund preview failed',
    subscriptionRefundRedirect: 'Subscription order refunds now use the subscription refund flow. Please submit it from the subscription page.',
    effectiveRefundAmount: 'Effective Refund',
    gatewayRefundAmount: 'Gateway Refund',
       refundResidualValue: 'Residual Refund',
       refundFeeAmount: 'Refund Fee',
    calculationTitle: 'Refund Calculation',
    calculationIntro: 'The preview shows the current residual value, the gateway-refundable amount, and whether any manual difference remains.',
       calculationResidualFormula: 'Residual refund',
       calculationFeeFormula: 'Fee = residual x 5%, capped at 10',
       calculationNetFormula: 'Effective refund = residual - fee',
    calculationGatewayFormula: 'Gateway refund',
    calculationManualFormula: 'Manual difference = residual refund - gateway refund',
    calculationManualRequiredHint: 'If the manual difference is greater than 0, the payment gateway cannot fully cover the residual and follow-up manual handling is required.',
    calculationManualWaivedHint: 'If the manual difference is 0, the refund can be fully completed through the payment gateway.',
    ...
    errors: {
      ...
      CUSTOM_RECHARGE_AMOUNT_DISABLED: 'Only the listed quick recharge amounts are currently allowed.',
      ...
      INVALID_ORDER_TYPE: 'Only balance or subscription orders can request a refund.',
      ...
      USER_REFUND_DISABLED: 'This order does not support self-service refunds.',
      REFUND_DISABLED: 'Refunds are not enabled for this payment provider.',
      PROVIDER_LOOKUP_FAILED: 'Failed to look up the payment provider.',
      REFUND_REQUIRES_ADMIN_REVIEW: 'This subscription refund requires admin review.',
      SETTLEMENT_REFUND_ALREADY_PENDING: 'A refund request for this subscription is already in progress.',
      SETTLEMENT_REFUND_PREVIEW_EXPIRED: 'This refund preview has expired. Please recalculate it.',
      SETTLEMENT_REFUND_PREVIEW_STALE: 'This refund preview is no longer valid. Please recalculate it.',
      SETTLEMENT_REFUND_PREVIEW_TOKEN_INVALID: 'The refund preview token is invalid. Please recalculate it.',
      SETTLEMENT_REFUND_MANUAL_RECEIVER_REQUIRED: 'Manual transfer is required. Please complete the receiver details first.',
      SETTLEMENT_REFUND_MANUAL_RECEIVER_IMAGE_INVALID: 'The receiver QR image reference is invalid. Enter a valid image URL or stored path.',
      SETTLEMENT_REFUND_COMPLETE_MANUAL_PROOF_REQUIRED: 'A manual transfer proof URL is required before completing this refund.',
      SETTLEMENT_REFUND_MANUAL_PROOF_REQUIRED: 'Please enter the manual transfer proof URL first.',
      SETTLEMENT_REFUND_MANUAL_PROOF_INVALID: 'The manual transfer proof reference is invalid. Enter a valid image URL or stored path.',
      SETTLEMENT_REFUND_CANNOT_CANCEL_AFTER_PAYOUT: 'This request cannot be cancelled after any payout has been made.',
      REFUND_FAILED: 'Refund failed.',
      RECHARGE_QUOTE_CHANGED: 'The recharge quote expired or changed. Refresh and try again.',
      INVALID_RECHARGE_BONUS_RULE: 'The recharge promotion rule is invalid.',
      RECHARGE_BONUS_RULE_CONFLICT: 'An enabled rule with the same priority overlaps this amount and time range.',
      RECHARGE_BONUS_RULE_IN_USE: 'This rule is used by an order and can only be disabled.',
      RECHARGE_BONUS_RULE_NOT_FOUND: 'Recharge promotion rule not found.',
    },
    ...
    renewNow: 'Renew',
    upgradeNow: 'Upgrade',
    notSupportedYet: 'Unavailable',
    plan: 'Plan',
    currentPlan: 'Current Plan',
    targetPlan: 'Target Plan',
    selectPlan: 'Select Plan',
    residualValue: 'Residual Credit',
    upgradeDelta: 'Upgrade Delta',
    upgradePreviewHint: 'The upgrade charge is reduced by the remaining value of your current plan.',
    upgradeCalculationTitle: 'Upgrade Calculation',
    upgradeCalculationIntro: 'The upgrade amount first converts the remaining value of your current plan into credit, then deducts that credit from the target plan price using the active payment currency precision.',
    upgradeCalculationCurrentFormula: 'Unit Value Cost',
    upgradeCalculationResidualFormula: 'Residual Credit',
    ...
    admin: {
      ...
      noData: 'No data',
      rechargeBonus: {
        create: 'Add Recharge Promotion',
        edit: 'Edit Recharge Promotion',
        delete: 'Delete Recharge Promotion',
        deleteConfirm: 'Delete this recharge promotion rule?',
        deleteInUse: 'This rule may be used by an order. Disable it instead.',
        name: 'Rule Name',
        enabled: 'Enabled',
        statusLabel: 'Status',
        priority: 'Priority',
        amountRange: 'Recharge Range',
        minAmount: 'Minimum Recharge',
        maxAmount: 'Maximum Recharge',
        bonus: 'Bonus',
        ...
        invalidAmountRange: 'Maximum recharge cannot be lower than minimum recharge.',
        invalidPercentage: 'Percentage bonus cannot exceed 100%.',
        invalidTimeRange: 'End time must be later than start time.',
        status: { active: 'Active', upcoming: 'Upcoming', ended: 'Ended', disabled: 'Disabled' },
      },
      days: 'days',
      weeks: 'weeks',
      months: 'months',
      ...
      refundPreview: 'Refund Preview',
      refundPreviewLoading: 'Calculating refund preview...',
      refundPreviewFailed: 'Refund preview failed',
      subscriptionRefundRedirect: 'Subscription order refunds now use settlement refund requests. Please handle them from the refund request list.',
      affiliateRewardWarningTitle: 'This order triggered invite rewards',
      affiliateRewardWarningBody: 'Refunding does not automatically claw back inviter rebate quota or timed exclusive group access. Confirm whether manual handling is required.',
      affiliateRebateApplied: 'Rebate issued: {amount}',
      affiliateInviterId: 'Inviter user ID: {id}',
      affiliateGroupGrantApplied: 'Timed exclusive group granted: {days} days',
      affiliateGroupGrantExpiresAt: 'Current timed group expiry: {time}',
      effectiveRefundAmount: 'Effective Refund',
      currentResidualValue: 'Current Residual Value',
      refundResidualValue: 'Residual Refund',
      gatewayRefundAmount: 'Gateway Refund',
      calculationTitle: 'Refund Calculation',
      calculationIntro: 'The preview shows the current residual value, the gateway-refundable amount, and whether any manual difference remains.',
      ...
      deductSubscription: 'Reclaim Subscription',
      deductSubscriptionHint: 'Calculate the actual refund from current residual value',
      ...
      validityValueRequired: 'Validity value must be greater than 0',

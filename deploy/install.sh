...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/wlm1473319989/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="wlm1473319989/sub2api"
...
Documentation=https://github.com/wlm1473319989/sub2api

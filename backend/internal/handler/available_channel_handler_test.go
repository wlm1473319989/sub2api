...
func TestUserAvailableChannel_FieldWhitelist(t *testing.T) {
	...
	// Group DTO 暴露区分专属/公开、默认倍率、订阅倍率和高峰倍率规则所需的字段，
	...
	for _, key := range []string{"id", "name", "platform", "rate_multiplier", "subscription_rate_multiplier", "peak_rate_enabled", "peak_start", "peak_end", "peak_rate_multiplier", "is_exclusive"} {

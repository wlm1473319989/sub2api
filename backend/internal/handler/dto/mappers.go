...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		AllowPaidFailover: k.AllowPaidFailover,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		GroupID:                    l.GroupID,
		OriginGroupID:              l.OriginGroupID,
		RoutedGroupID:              l.RoutedGroupID,
		FailoverReason:             l.FailoverReason,
		...
		SubscriptionRateMultiplier: l.SubscriptionRateMultiplier,
		BalanceRateMultiplier:      l.BalanceRateMultiplier,

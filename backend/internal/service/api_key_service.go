...
// GetAvailableGroups returns the groups the user may bind to an API key.
// Public groups are available to all active users; exclusive groups require
// explicit membership in allowed_groups.

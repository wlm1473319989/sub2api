...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "allow_paid_failover", Type: field.TypeBool, Default: false},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "backup_failover_enabled", Type: field.TypeBool, Default: false},
		{Name: "backup_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "backup_failover_config", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "recharge_principal", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "recharge_bonus", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "recharge_bonus_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "refunded_bonus_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "refunded_principal_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "refunded_gateway_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		{Name: "subscription_plan_name_snapshot", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "subscription_plan_price_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "subscription_validity_days_snapshot", Type: field.TypeInt, Nullable: true},
		{Name: "subscription_daily_quota_knives_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "subscription_weekly_quota_knives_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "subscription_monthly_quota_knives_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "recharge_bonus_rule_id", Type: field.TypeInt64, Nullable: true},
		{Name: "user_id", Type: field.TypeInt64},
	}
	...
	PaymentOrdersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "payment_orders_recharge_bonus_rules_payment_orders",
				Columns:    []*schema.Column{PaymentOrdersColumns[50]},
				RefColumns: []*schema.Column{RechargeBonusRulesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PaymentOrdersColumns[15], PaymentOrdersColumns[41]},
			},
			{
			...
			{
				Name:    "paymentorder_recharge_bonus_rule_id",
				Unique:  false,
				Columns: []*schema.Column{PaymentOrdersColumns[50]},
			},
			{
				Name:    "paymentorder_subscription_action",
				Unique:  false,
	...
	// RechargeBonusRulesColumns holds the columns for the "recharge_bonus_rules" table.
	RechargeBonusRulesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "enabled", Type: field.TypeBool, Default: true},
		{Name: "priority", Type: field.TypeInt, Default: 0},
		{Name: "min_amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "max_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "bonus_type", Type: field.TypeString, Size: 20},
		{Name: "bonus_value", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,4)"}},
		{Name: "starts_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "ends_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "notes", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	// RechargeBonusRulesTable holds the schema information for the "recharge_bonus_rules" table.
	RechargeBonusRulesTable = &schema.Table{
		Name:       "recharge_bonus_rules",
		Columns:    RechargeBonusRulesColumns,
		PrimaryKey: []*schema.Column{RechargeBonusRulesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "rechargebonusrule_enabled_priority",
				Unique:  false,
				Columns: []*schema.Column{RechargeBonusRulesColumns[2], RechargeBonusRulesColumns[3]},
			},
			{
				Name:    "rechargebonusrule_starts_at_ends_at",
				Unique:  false,
				Columns: []*schema.Column{RechargeBonusRulesColumns[8], RechargeBonusRulesColumns[9]},
			},
		},
	}
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "plan_id", Type: field.TypeInt64, Nullable: true},
		{Name: "group_redeem_codes", Type: field.TypeInt64, Nullable: true},
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "daily_quota_knives", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "weekly_quota_knives", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_quota_knives", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "purchase_limit_per_user", Type: field.TypeInt, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "origin_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "routed_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "failover_reason", Type: field.TypeString, Nullable: true, Size: 64},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_origin_group_id",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[9]},
			},
			{
				Name:    "usagelog_routed_group_id",
				Unique:  false,
			...
			{
				Name:    "usagelog_origin_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[9], UsageLogsColumns[43]},
			},
			{
				Name:    "usagelog_routed_group_id_created_at",
				Unique:  false,
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "plan_id", Type: field.TypeInt64, Nullable: true},
		{Name: "plan_name_snapshot", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "plan_price_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "weekly_quota_knives", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_quota_knives", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "daily_used_knives", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "weekly_used_knives", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_used_knives", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "superseded_by_id", Type: field.TypeInt64, Nullable: true},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[25], UserSubscriptionsColumns[9], UserSubscriptionsColumns[8]},
			},
			{
			...
			{
				Name:    "usersubscription_superseded_by_id",
				Unique:  false,
...
func init() {
	...
	PaymentOrdersTable.ForeignKeys[0].RefTable = RechargeBonusRulesTable
	...
	RechargeBonusRulesTable.Annotation = &entsql.Annotation{

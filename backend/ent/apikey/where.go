...
// AllowPaidFailover applies equality check predicate on the "allow_paid_failover" field. It's identical to AllowPaidFailoverEQ.
func AllowPaidFailover(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldAllowPaidFailover, v))
}
...
// AllowPaidFailoverEQ applies the EQ predicate on the "allow_paid_failover" field.
func AllowPaidFailoverEQ(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldAllowPaidFailover, v))
}

// AllowPaidFailoverNEQ applies the NEQ predicate on the "allow_paid_failover" field.
func AllowPaidFailoverNEQ(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldNEQ(FieldAllowPaidFailover, v))
}

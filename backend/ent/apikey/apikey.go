...
const (
	...
	// FieldAllowPaidFailover holds the string denoting the allow_paid_failover field in the database.
	FieldAllowPaidFailover = "allow_paid_failover"
...
var (
	...
	// DefaultAllowPaidFailover holds the default value on creation for the "allow_paid_failover" field.
	DefaultAllowPaidFailover bool
)
...
// ByAllowPaidFailover orders the results by the allow_paid_failover field.
func ByAllowPaidFailover(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAllowPaidFailover, opts...).ToFunc()
}
